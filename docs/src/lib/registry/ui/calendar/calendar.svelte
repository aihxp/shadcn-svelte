<script lang="ts">
	...
	const calendarProps = $derived(
		restProps as WithoutChildrenOrChild<CalendarPrimitive.RootProps>
	);
	const rangeCalendarProps = $derived(
		restProps as WithoutChildrenOrChild<RangeCalendarPrimitive.RootProps>
	);
</script>
